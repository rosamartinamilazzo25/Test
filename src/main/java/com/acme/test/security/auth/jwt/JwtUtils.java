package com.acme.test.security.auth.jwt;
...
import com.acme.test.security.auth.users.UserDetailsImpl;
import com.acme.test.security.auth.users.UserResponse;
import com.acme.test.security.auth.users.UserService;
